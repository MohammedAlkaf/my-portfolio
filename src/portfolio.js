...
const about = {
  ...
  resume:
    "https://acrobat.adobe.com/link/review?uri=urn:aaid:scds:US:ff3b19ab-8f74-35df-96f1-901e77630feb",
  social: {
...
const projects = [
  ...
  // if there are no projects, Projects section won't show up
  {
    ...
    livePreview: 'https://www.youtube.com/watch?v=BVm9BsRPkzM',
  },
  {
    ...
    description: `(Work on Progress) Haya is a MERN stack e-commerece website for shopping with a responsive design for all devices. The user can log in/sign up, check the products available at the store, 
  ...
  },
  {
    ...
    description: `Hangman is an old school favorite, a word game where the goal is simply to find the missing word or words.
  ...
  },
  {
    name: "Fruit Emporium",
    photo: [
      "https://i.ibb.co/8dp9yP3/Eco-System1.png",
      "https://i.ibb.co/1RRnBvS/Eco-System2.png",
      "https://i.ibb.co/bJ71fW6/Eco-System3.png",
    ],
    description:
  ...
  },
  {
    ...
    description: `Car Dodge is built using Object Oriented Programming. In the game, you are the car driver. You can ove left, right, up ad down with the arrows of your keyboard and dodge cars.`,
